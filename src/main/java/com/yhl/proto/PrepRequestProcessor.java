...
import com.yhl.quorum.Leader;
import com.yhl.record.*;
...
public class PrepRequestProcessor extends Thread implements RequestProcessor {
    ...
    HashMap<String, ZooKeeperServer.ChangeRecord> getPendingChanges(MultiTransactionRecord multiRequest) {
        ...
        for(com.yhl.Op op: multiRequest) {
    ...
    void rollbackPendingChanges(long zxid, HashMap<String, ZooKeeperServer.ChangeRecord>pendingChangeRecords) {
        ...
        synchronized (zks.outstandingChanges) {
            ...
            Iterator<ZooKeeperServer.ChangeRecord> priorIter = pendingChangeRecords.values().iterator();
...
//                }
    ...
    protected void pRequest2Txn(int type, long zxid, Request request, Record record, boolean deserialize)
        throws KeeperException, IOException, com.yhl.proto.RequestProcessor.RequestProcessorException
    {
