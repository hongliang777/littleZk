...
//import com.yhl.util.AtomicFileWritingIdiom;
//import com.yhl.util.PathUtils;
//import com.yhl.util.StringUtils;
//import com.yhl.util.VerifyingFileFactory;
...
//                    peerType = QuorumPeer.LearnerType.OBSERVER;
//                } else if (value.toLowerCase().equals("participant")) {
//                    peerType = QuorumPeer.LearnerType.PARTICIPANT;
//                } else
//                {
...
//        new AtomicFileWritingIdiom(new File(configFileStr + ".bak"), new AtomicFileWritingIdiom.OutputStreamStatement() {
//            @Override
