...
public class Leader {
    ...
    void lead() throws IOException, InterruptedException {
        ...
        try {
            ...
            // acknowledged
            try {
                waitForNewLeaderAck(self.getId(), zk.getZxid(), QuorumPeer.LearnerType.PARTICIPANT);
     ...
     * @throws InterruptedException
     */
    public void waitForNewLeaderAck(long sid, long zxid, QuorumPeer.LearnerType learnerType)
            throws InterruptedException {
