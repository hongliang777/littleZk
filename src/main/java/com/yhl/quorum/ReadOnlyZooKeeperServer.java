...
package com.yhl.quorum;

import com.yhl.MBeanRegistry;
import com.yhl.ZKDatabase;
import com.yhl.ZooKeeperServer;
import com.yhl.ZooKeeperServerBean;
import com.yhl.datastructure.DataTreeBean;
import com.yhl.proto.FinalRequestProcessor;
import com.yhl.proto.PrepRequestProcessor;
import com.yhl.proto.RequestProcessor;
...
public class ReadOnlyZooKeeperServer extends QuorumZooKeeperServer {
    ...
    ReadOnlyZooKeeperServer(FileTxnSnapLog logFactory, QuorumPeer self,
            ZooKeeperServer.DataTreeBuilder treeBuilder, ZKDatabase zkDb) {
