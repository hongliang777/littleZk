...
import com.yhl.datastructure.DataTreeBean;
import com.yhl.datastructure.StatPersisted;
import com.yhl.proto.*;
import com.yhl.quorum.ReadOnlyZooKeeperServer;
import com.yhl.record.ACL;
import com.yhl.record.AuthPacket;
import com.yhl.record.Id;
import com.yhl.record.Record;
import com.yhl.txn.CreateSessionTxn;
import com.yhl.util.FileTxnSnapLog;
import com.yhl.util.ZooDefs;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.yhl.proto.SessionTracker.SessionExpirer;
...
public class ZooKeeperServer implements SessionExpirer, ServerStats.Provider {
    ...
    public static final int DEFAULT_TICK_TIME = 3000000;
    ...
    public static class ChangeRecord {
        public ChangeRecord(long zxid, String path, StatPersisted stat, int childCount,
                List<ACL> acl) {
            this.zxid = zxid;
            this.path = path;
            this.stat = stat;
        ...
        public StatPersisted stat; /* Make sure to create a new object when changing */

        public int childCount;

        public List<ACL> acl; /* Make sure to create a new object when changing */

        @SuppressWarnings("unchecked")
        public ChangeRecord duplicate(long zxid) {
...
//        }
    ...
    public DataTree.ProcessTxnResult processTxn(TxnHeader hdr, Record txn) {
        ...
        DataTree.ProcessTxnResult rc = getZKDatabase().processTxn(hdr, txn);
